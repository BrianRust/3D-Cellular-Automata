...
namespace ConstantParameters
{
	...
	const unsigned int SOLID_BLOCK_PERCENTAGE_3D = 14;
	const unsigned int BLACK_BLOCK_PERCENTAGE = 50;
...
enum ImmediateNeighbors3D
{
	NEIGHBOR_WEST_3D,
	NEIGHBOR_SOUTH_3D,
	NEIGHBOR_SOUTHWEST_3D,
	NEIGHBOR_NORTH_3D,
	NEIGHBOR_NORTHWEST_3D,
	NEIGHBOR_EAST_3D,
	NEIGHBOR_SOUTHEAST_3D,
	NEIGHBOR_NORTHEAST_3D,
	NEIGHBOR_UP_3D,
	NEIGHBOR_DOWN_3D,
	NEIGHBOR_UP_WEST_3D,
	NEIGHBOR_DOWN_WEST_3D,
	NEIGHBOR_UP_SOUTH_3D,
	NEIGHBOR_DOWN_SOUTH_3D,
	NEIGHBOR_UP_SOUTHWEST_3D,
	NEIGHBOR_DOWN_SOUTHWEST_3D,
	NEIGHBOR_UP_NORTH_3D,
	NEIGHBOR_DOWN_NORTH_3D,
	NEIGHBOR_UP_NORTHWEST_3D,
	NEIGHBOR_DOWN_NORTHWEST_3D,
	NEIGHBOR_UP_EAST_3D,
	NEIGHBOR_DOWN_EAST_3D,
	NEIGHBOR_UP_SOUTHEAST_3D,
	NEIGHBOR_DOWN_SOUTHEAST_3D,
	NEIGHBOR_UP_NORTHEAST_3D,
	NEIGHBOR_DOWN_NORTHEAST_3D,
	NUM_NEIGHBORS_3D
};
